{{-- Steps markup extracted from legacy public/diagnostico.php --}}
...
<div class="step" id="step6">
    ...
    <div class="consent-wrapper">
        <label class="consent-label">
            ...
            <span>Li e concordo com a <a href="{{ url('/privacidade') }}" target="_blank">Política de Privacidade</a></span>
        </label>
    </div>
...
<div class="step" id="stepResult">
    ...
    <a href="{{ route('landing') }}" class="btn-home">← Voltar ao início</a>
</div>
