...
<section id="hero">
    <div class="container">
        <div class="section-content animate-on-scroll">
            ...
            <div class="hero-ctas">
                <a href="/diagnostico" class="btn-primary" data-i18n="hero.cta_diagnosis">Agendar diagnóstico (30 min)</a>
                <a href="https://wa.me/<?= urlencode($config['whatsapp']) ?>" target="_blank" rel="noopener" class="btn-secondary" data-i18n="hero.cta_whatsapp">WhatsApp</a>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="contact-content animate-on-scroll">
            ...
            <div class="contact-buttons">
                <a href="https://wa.me/<?= urlencode($config['whatsapp']) ?>" target="_blank" rel="noopener" class="btn-primary btn-whatsapp" data-i18n="contact.whatsapp">Chamar no WhatsApp</a>
                <a href="mailto:<?= htmlspecialchars($config['email']) ?>" class="btn-secondary" data-i18n="contact.email">contato@ftit.com.br</a>
            </div>
...
<footer id="footer">
    <div class="container">
        ...
        <p class="footer-privacy">
            <a href="/privacidade" data-i18n="footer.privacy">Política de Privacidade</a>
