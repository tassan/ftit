...
$page = [
    ...
    'description' => 'Seu diagnóstico digital foi enviado. Entraremos em contato em breve.',
    'url'         => rtrim($config['base_url'], '/') . '/obrigado',
];
?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<main style="min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:2rem;">
    ...
    <a href="/" style="font-family:var(--font-mono);color:var(--accent-purple);text-decoration:none;font-size:0.9rem;">← Voltar para o início</a>
</main>
</body>
</html>
